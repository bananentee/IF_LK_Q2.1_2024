 ...
 * </p>
 * <p>
 * Klasse abiturklassen.Server
 * </p>
 * <p>
 * Objekte von Unterklassen der abstrakten Klasse abiturklassen.Server ermoeglichen das
 * Anbieten von Serverdiensten, so dass Clients Verbindungen zum abiturklassen.Server mittels
...
public abstract class Server {
    ...
    private class NewConnectionHandler extends Thread {
        ...
        public void run() {
            while (active) {
                try {
                    //Warten auf Verbdinungsversuch durch abiturklassen.Client:
                    Socket clientSocket = serverSocket.accept();
                    // Eingehende Nachrichten vom neu verbundenen abiturklassen.Client werden
                    ...
                    /*
                     * Kann keine Verbindung zum anfragenden abiturklassen.Client aufgebaut werden,
                     * geschieht nichts.
                     */
                }
            }
